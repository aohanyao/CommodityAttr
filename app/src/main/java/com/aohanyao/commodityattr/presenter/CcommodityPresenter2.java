 ...
 * <p>没有使用Rxjava的版本</p>
 */
public class CcommodityPresenter2 implements CcommodityPresenterInf, View.OnClickListener {
    ...
    public CcommodityPresenter2(Activity mActivity, ShopDeialPresenterCallBack callBack) {
