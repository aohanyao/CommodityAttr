 ...
 * <p>使用Rxjava来进行筛选</p>
 */
public class CcommodityPresenter_RxJava implements CcommodityPresenterInf, View.OnClickListener {
    ...
    public CcommodityPresenter_RxJava(Activity mActivity, ShopDeialPresenterCallBack callBack) {
